...
- [x] ✅ **English SEO** — `/en/` paths + hreflang + locale-aware internal links **MERGED & LIVE** ([PR #2](https://github.com/amox-ws/physiodanali/pull/2)). Σημαντικό λόγω πολλών ξένων πελατών. *(βλ. [seo-plan.md](seo-plan.md) §2)*
