...
## 📅 Booking
- [ ] **5. Και τις 8 υπηρεσίες** (από homepage): Φυσικοθεραπεία κατ' οίκον, Χειροπρακτική, Κύφωση, Brazilian lymphatic drainage, Clinical Pilates, Αυχεναλγία, Οσφυαλγία, Ισχιαλγία. (Τώρα έχει 6 placeholder.)
- [ ] **6. Τιμές & διάρκειες:** μόνο 2 → **60′ = 100€**, **30′ = 50€**. Σημείωση «δεκτά μετρητά & κάρτα». *(ΑΝΟΙΧΤΟ: ποιες από τις 8 είναι 60′ και ποιες 30′;)*
